...
public class DomainServiceConfig {
    ...
    @Bean
    public BotMessageService botMessageService(FeishuGateway feishuGateway, AppRouter appRouter, AppRegistry appRegistry) {
        return new BotMessageService(feishuGateway, appRouter, appRegistry);
    }
}
