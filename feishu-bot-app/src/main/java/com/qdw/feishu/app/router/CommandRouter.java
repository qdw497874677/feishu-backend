...
@Slf4j
@Component("commandRouterImpl")
public class CommandRouter implements com.qdw.feishu.domain.router.CommandRouter {
    ...
    public CommandRouter(List<CommandExecutorI> allExecutors) {
        ...
        log.info("CommandRouter initialized with {} commands: {}", executors.size(), executors.keySet());
    }
