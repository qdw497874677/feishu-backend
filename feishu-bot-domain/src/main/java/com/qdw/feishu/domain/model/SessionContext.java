 ...
 * 会话上下文领域实体
 *
 * 封装话题级别的会话容器，用于持久化话题上下文
 * 每个话题对应一个 SessionContext，可包含多个应用的会话
 */
@Data
@NoArgsConstructor
public class SessionContext {
     ...
     * @param appId 应用 ID
     */
    public SessionContext(String topicId, String appId) {
     ...
     */
    public SessionContext(String topicId, String appId, String metadata) {
