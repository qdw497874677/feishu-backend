...
class NextStepSuggesterTest {
    ...
    void should_suggestSessions_after_projects() {
        String suggestion = suggester.suggest("projects", TopicState.INITIALIZED, MessageContext.unresolved());
    ...
    void should_suggestSessions_after_projectsAliasP() {
        String suggestion = suggester.suggest("p", TopicState.INITIALIZED, MessageContext.unresolved());
        assertNotNull(suggestion);
        assertTrue(suggestion.contains("sessions"), "应包含 sessions 建议");
    }
    ...
    void should_suggestSc_after_sessions() {
        String suggestion = suggester.suggest("sessions", TopicState.INITIALIZED, MessageContext.unresolved());
        assertNotNull(suggestion);
    ...
    void should_suggestDirectInput_after_sc() {
        String suggestion = suggester.suggest("sc", TopicState.INITIALIZED, MessageContext.unresolved());
        assertNotNull(suggestion);
    ...
    void should_returnNull_after_chat() {
        String suggestion = suggester.suggest("chat", TopicState.INITIALIZED, MessageContext.unresolved());
    ...
    void should_returnNull_after_chatnow() {
        String suggestion = suggester.suggest("chatnow", TopicState.INITIALIZED, MessageContext.unresolved());
    ...
    void should_returnNull_after_cn() {
        String suggestion = suggester.suggest("cn", TopicState.INITIALIZED, MessageContext.unresolved());
    ...
    void should_suggestScOrSessions_after_reset() {
        String suggestion = suggester.suggest("reset", TopicState.UNINITIALIZED, MessageContext.unresolved());
        assertNotNull(suggestion);
    ...
    void should_suggestChat_after_status_initialized() {
        String suggestion = suggester.suggest("status", TopicState.INITIALIZED, MessageContext.unresolved());
        assertNotNull(suggestion);
    ...
    void should_suggestSc_after_status_uninitialized() {
        String suggestion = suggester.suggest("status", TopicState.UNINITIALIZED, MessageContext.unresolved());
        assertNotNull(suggestion);
    ...
    void should_returnNull_after_help() {
        String suggestion = suggester.suggest("help", TopicState.INITIALIZED, MessageContext.unresolved());
    ...
    void should_returnNull_after_commands() {
        String suggestion = suggester.suggest("commands", TopicState.INITIALIZED, MessageContext.unresolved());
